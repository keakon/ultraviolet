	...
	cases := []struct {
		...
		},
		{
			...
			expected: &Buffer{
				Lines: []Line{
					{
						newWcCell("H", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold}, nil),
						newWcCell("e", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold}, nil),
						newWcCell("l", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold}, nil),
						newWcCell("l", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold}, nil),
						newWcCell("o", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold}, nil),
						newWcCell(",", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold}, nil),
						newWcCell(" ", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold}, nil),
						newWcCell("W", &Style{Fg: ColorFrom(ansi.Green), Underline: UnderlineStyleSingle}, nil),
						newWcCell("o", &Style{Fg: ColorFrom(ansi.Green), Underline: UnderlineStyleSingle}, nil),
						newWcCell("r", &Style{Fg: ColorFrom(ansi.Green), Underline: UnderlineStyleSingle}, nil),
						newWcCell("l", &Style{Fg: ColorFrom(ansi.Green), Underline: UnderlineStyleSingle}, nil),
						newWcCell("d", &Style{Fg: ColorFrom(ansi.Green), Underline: UnderlineStyleSingle}, nil),
						newWcCell("!", &Style{Fg: ColorFrom(ansi.Green), Underline: UnderlineStyleSingle}, nil),
					},
				},
			},
		},
		{
			...
			expected: &Buffer{
				Lines: []Line{
					{
						newWcCell("R", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold | AttrFaint}, nil),
						newWcCell("e", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold}, nil),
						newWcCell("d", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold}, nil),
						newWcCell(" ", nil, nil),
						newWcCell("G", &Style{Fg: ColorFrom(ansi.Green), Attrs: AttrItalic}, nil),
						newWcCell("r", &Style{Fg: ColorFrom(ansi.Green), Attrs: AttrItalic}, nil),
						newWcCell("e", &Style{Fg: ColorFrom(ansi.Green), Attrs: AttrItalic}, nil),
						newWcCell("e", &Style{Fg: ColorFrom(ansi.Green), Attrs: AttrItalic}, nil),
						newWcCell("n", &Style{Fg: ColorFrom(ansi.Green), Attrs: AttrItalic}, nil),
						newWcCell(" ", nil, nil),
						newWcCell("B", &Style{Fg: ColorFrom(ansi.Blue), Attrs: AttrStrikethrough}, nil),
						newWcCell("l", &Style{Fg: ColorFrom(ansi.Blue), Attrs: AttrStrikethrough}, nil),
						newWcCell("u", &Style{Fg: ColorFrom(ansi.Blue), Attrs: AttrStrikethrough}, nil),
						newWcCell("e", &Style{Fg: ColorFrom(ansi.Blue), Attrs: AttrStrikethrough}, nil),
						newWcCell(" ", nil, nil),
						newWcCell("Y", &Style{Fg: ColorFrom(ansi.Yellow), Attrs: AttrReverse}, nil),
						newWcCell("e", &Style{Fg: ColorFrom(ansi.Yellow), Attrs: AttrReverse}, nil),
						newWcCell("l", &Style{Fg: ColorFrom(ansi.Yellow), Attrs: AttrReverse}, nil),
						newWcCell("l", &Style{Fg: ColorFrom(ansi.Yellow), Attrs: AttrReverse}, nil),
						newWcCell("o", &Style{Fg: ColorFrom(ansi.Yellow), Attrs: AttrReverse}, nil),
						newWcCell("w", &Style{Fg: ColorFrom(ansi.Yellow), Attrs: AttrReverse}, nil),
						newWcCell(" ", nil, nil),
						newWcCell("P", &Style{Fg: ColorFrom(ansi.Magenta), Attrs: AttrBlink}, nil),
						newWcCell("u", &Style{Fg: ColorFrom(ansi.Magenta), Attrs: AttrBlink}, nil),
						newWcCell("r", &Style{Fg: ColorFrom(ansi.Magenta), Attrs: AttrBlink}, nil),
						newWcCell("p", &Style{Fg: ColorFrom(ansi.Magenta), Attrs: AttrBlink}, nil),
						newWcCell("l", &Style{Fg: ColorFrom(ansi.Magenta), Attrs: AttrBlink}, nil),
						newWcCell("e", &Style{Fg: ColorFrom(ansi.Magenta), Attrs: AttrBlink}, nil),
					},
				},
			},
		},
		...
		},
		{
			...
			expected: &Buffer{
				Lines: []Line{
					{
						newWcCell("R", &Style{Fg: ColorFrom(color.RGBA{R: 255, G: 0, B: 0, A: 255})}, nil),
						newWcCell("G", &Style{Fg: ColorFrom(color.RGBA{R: 255, G: 0, B: 0, A: 255})}, nil),
						newWcCell("B", &Style{Fg: ColorFrom(color.RGBA{R: 255, G: 0, B: 0, A: 255})}, nil),
						newWcCell(" ", &Style{Fg: ColorFrom(color.RGBA{R: 255, G: 0, B: 0, A: 255})}, nil),
						newWcCell("R", &Style{Fg: ColorFrom(color.RGBA{R: 255, G: 0, B: 0, A: 255})}, nil),
						newWcCell("e", &Style{Fg: ColorFrom(color.RGBA{R: 255, G: 0, B: 0, A: 255})}, nil),
						newWcCell("d", &Style{Fg: ColorFrom(color.RGBA{R: 255, G: 0, B: 0, A: 255})}, nil),
						newWcCell(" ", nil, nil),
						newWcCell("R", &Style{Bg: ColorFrom(color.RGBA{R: 0, G: 255, B: 0, A: 255})}, nil),
						newWcCell("G", &Style{Bg: ColorFrom(color.RGBA{R: 0, G: 255, B: 0, A: 255})}, nil),
						newWcCell("B", &Style{Bg: ColorFrom(color.RGBA{R: 0, G: 255, B: 0, A: 255})}, nil),
						newWcCell(" ", &Style{Bg: ColorFrom(color.RGBA{R: 0, G: 255, B: 0, A: 255})}, nil),
						newWcCell("G", &Style{Bg: ColorFrom(color.RGBA{R: 0, G: 255, B: 0, A: 255})}, nil),
						newWcCell("r", &Style{Bg: ColorFrom(color.RGBA{R: 0, G: 255, B: 0, A: 255})}, nil),
						newWcCell("e", &Style{Bg: ColorFrom(color.RGBA{R: 0, G: 255, B: 0, A: 255})}, nil),
						newWcCell("e", &Style{Bg: ColorFrom(color.RGBA{R: 0, G: 255, B: 0, A: 255})}, nil),
						newWcCell("n", &Style{Bg: ColorFrom(color.RGBA{R: 0, G: 255, B: 0, A: 255})}, nil),
						newWcCell(" ", &Style{Bg: ColorFrom(color.RGBA{R: 0, G: 255, B: 0, A: 255})}, nil),
						newWcCell("B", &Style{Bg: ColorFrom(color.RGBA{R: 0, G: 255, B: 0, A: 255})}, nil),
						newWcCell("G", &Style{Bg: ColorFrom(color.RGBA{R: 0, G: 255, B: 0, A: 255})}, nil),
						newWcCell(" ", nil, nil),
						newWcCell("2", &Style{Fg: ColorFrom(ansi.IndexedColor(33))}, nil),
						newWcCell("5", &Style{Fg: ColorFrom(ansi.IndexedColor(33))}, nil),
						newWcCell("6", &Style{Fg: ColorFrom(ansi.IndexedColor(33))}, nil),
						newWcCell(" ", &Style{Fg: ColorFrom(ansi.IndexedColor(33))}, nil),
						newWcCell("B", &Style{Fg: ColorFrom(ansi.IndexedColor(33))}, nil),
						newWcCell("l", &Style{Fg: ColorFrom(ansi.IndexedColor(33))}, nil),
						newWcCell("u", &Style{Fg: ColorFrom(ansi.IndexedColor(33))}, nil),
						newWcCell("e", &Style{Fg: ColorFrom(ansi.IndexedColor(33))}, nil),
						newWcCell("e", &Style{Fg: ColorFrom(ansi.IndexedColor(33))}, nil),
					},
				},
			},
				...
				Lines: []Line{
					{
						...
						newWcCell("l", nil, nil),
						newWcCell(" ", nil, nil),
						newWcCell("C", nil, newWcLink("https://charm.sh")),
						newWcCell("h", nil, newWcLink("https://charm.sh")),
						newWcCell("a", nil, newWcLink("https://charm.sh")),
						newWcCell("r", nil, newWcLink("https://charm.sh")),
						newWcCell("m", nil, newWcLink("https://charm.sh")),
						newWcCell(" ", nil, nil),
						newWcCell("T", nil, nil),
						newWcCell("e", nil, nil),
						newWcCell("x", nil, nil),
						newWcCell("t", nil, nil),
						newWcCell(" ", nil, nil),
						newWcCell("G", nil, newWcLink("https://github.com/charmbracelet")),
						newWcCell("i", nil, newWcLink("https://github.com/charmbracelet")),
						newWcCell("t", nil, newWcLink("https://github.com/charmbracelet")),
						newWcCell("H", nil, newWcLink("https://github.com/charmbracelet")),
						newWcCell("u", nil, newWcLink("https://github.com/charmbracelet")),
						newWcCell("b", nil, newWcLink("https://github.com/charmbracelet")),
					},
				},
			},
		},
		{
			...
			expected: &Buffer{
				Lines: []Line{
					{
						newWcCell("R", &Style{Fg: ColorFrom(ansi.Red), Attrs: AttrBold | AttrFaint | AttrItalic}, nil),
						newWcCell("e", &Style{Fg: ColorFrom(ansi.Red), Attrs: AttrBold}, nil),
						newWcCell("d", &Style{Fg: ColorFrom(ansi.Red), Attrs: AttrBold}, nil),
						newWcCell(" ", &Style{Fg: ColorFrom(ansi.Red), Attrs: AttrBold}, nil),
						newWcCell("C", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold}, newWcLink("https://charm.sh")),
						newWcCell("h", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold}, newWcLink("https://charm.sh")),
						newWcCell("a", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold}, newWcLink("https://charm.sh")),
						newWcCell("r", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold}, newWcLink("https://charm.sh")),
						newWcCell("m", &Style{Fg: ColorFrom(ansi.Red), Underline: UnderlineStyleSingle, Attrs: AttrBold}, newWcLink("https://charm.sh")),
						newWcCell(" ", nil, nil),
						newWcCell("G", &Style{Fg: ColorFrom(ansi.IndexedColor(33)), Bg: ColorFrom(color.RGBA{R: 0, G: 100, B: 0, A: 255})}, newWcLink("https://github.com")),
						newWcCell("i", &Style{Fg: ColorFrom(ansi.IndexedColor(33)), Bg: ColorFrom(color.RGBA{R: 0, G: 100, B: 0, A: 255})}, newWcLink("https://github.com")),
						newWcCell("t", &Style{Fg: ColorFrom(ansi.IndexedColor(33)), Bg: ColorFrom(color.RGBA{R: 0, G: 100, B: 0, A: 255})}, newWcLink("https://github.com")),
						newWcCell("H", &Style{Fg: ColorFrom(ansi.IndexedColor(33)), Bg: ColorFrom(color.RGBA{R: 0, G: 100, B: 0, A: 255})}, newWcLink("https://github.com")),
						newWcCell("u", &Style{Fg: ColorFrom(ansi.IndexedColor(33)), Bg: ColorFrom(color.RGBA{R: 0, G: 100, B: 0, A: 255})}, newWcLink("https://github.com")),
						newWcCell("b", &Style{Fg: ColorFrom(ansi.IndexedColor(33)), Bg: ColorFrom(color.RGBA{R: 0, G: 100, B: 0, A: 255})}, newWcLink("https://github.com")),
					},
				},
			},
		},
...
// newWcLink returns a pointer to a link for the cell helpers below.
func newWcLink(url string) *Link {
	l := NewLink(url)
	return &l
}
